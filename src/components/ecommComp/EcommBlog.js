       ...
       <Sec id = "ecommblog" className = "">
        <div className = "container">
            <div className = "title text-center py-5">
                <Title className = "position-relative d-inline-block" data-aos="zoom-in" data-aos-duration="2000">Blog</Title>
            </div>
            <div className = "row g-3">
               {blog.map((item) => (
                <div className = "card border-0 col-md-4 col-lg-4 bg-transparent my-3" data-aos="fade-up" data-aos-duration="2000">
