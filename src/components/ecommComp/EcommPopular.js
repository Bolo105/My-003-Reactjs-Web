      ...
      <Sec id = "ecommpopular" className = "">
        <div className = "container">
            <div className = "title text-center pt-3 pb-5">
                <Title className = "position-relative d-inline-block ms-4" data-aos="zoom-in" data-aos-duration="2000">Popular</Title>
            </div>
            <div className = "row">
              {popular.map((item) => (
              <div className = "col-md-6 col-lg-4 row g-3" data-aos="fade-left" data-aos-duration="2000">
