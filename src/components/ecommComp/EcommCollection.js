    ...
    <Port id="ecommcollection" className="portfolio">
      <div className="container">
             <div className = "title text-center pt-5 pb-3">
                <Title className = "position-relative d-inline-block" data-aos="zoom-in" data-aos-duration="2000">Collection</Title>
            </div>
        <div className="row">
          <div className="col-lg-12 d-flex justify-content-center" data-aos="fade-up">
          {category.map((category) => (
            <CatButton>
               <But className='primaryBtn' onClick={() => filterItems(category)} data-aos ='zoom-out-down' data-aos-duration="2000">
                  {category}
               </But>
            </CatButton>
           ))}
        ...
        <div className="row portfolio-container" data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000">
           {list.map((item) => (
