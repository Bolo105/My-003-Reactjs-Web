  ...
  return (
    ...
    <div className = "container">
        <div className = "title text-center py-5">
            <Title className = "position-relative d-inline-block" data-aos="zoom-in" data-aos-duration="2000">Special</Title>
        </div>
        <div className = "special-list row g-0">
            {special.map((item) => (
            <div className = "col-12 col-md-6 col-lg-3 p-2" data-aos="zoom-in" data-aos-duration="2000">
